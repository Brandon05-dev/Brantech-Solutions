...
import { MessageCircle, X, Send, Bot, User, UserRound, Headphones } from "lucide-react";
...
export function CustomerSupport() {
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
      ...
      {/* Floating Button with Girl Emoji */}
      <div className="relative flex items-center gap-2 sm:gap-3">
        ...
        <Button
          onClick={toggleWidget}
          className={`h-12 w-12 sm:h-16 sm:w-16 rounded-full bg-white/90 backdrop-blur-sm hover:bg-white shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 ${
